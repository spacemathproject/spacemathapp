...
ParamSpace[
				 ...
				 PP_
				 ] := RegionPlot[
						{
    					 ...
    					 (*,dmuINF<dmu[ghtaumu,gHtaumu,gAtaumu,mh,mH,mA]<dmuSUP*)
						},
					  	{x,xmin,xmax},
						{y,ymin,ymax},
						FrameLabel ->
						 {
						   Style[xlabel,Larger,Bold],
						   Style[ylabel,Larger,Bold],
						   Style["\!\(\*StyleBox[\"SpaceMath\",\nFontWeight->\"Bold\",\nFontSlant->\"Italic\"]\)",Medium,Bold]
						 },
						PlotLegends -> 
						 Placed[
								   {
								    "h\[Rule] \[Tau]\[Mu]",
									"\!\(\*SubscriptBox[\(\[Delta]a\), \(\[Mu]\)]\)",
									"\[Tau]\[Rule] 3\[Mu]",
									"\[Tau]\[Rule] \[Mu]\[Gamma]",
									"\!\(\*SubscriptBox[\(d\), \(\[Mu]\)]\)"
								   },
						...
						BoundaryStyle -> 
						 {
						   1 -> Directive[Blue, Dashed, Thickness[0.002], Opacity[10]],
						   2 -> Directive[Green, Dashed, Thickness[0.004], Opacity[10]],
						   3 -> Directive[Red, Dashed, Thickness[0.002], Opacity[10]],
						   4 -> Directive[Cyan, Dashed, Thickness[0.002], Opacity[10]],
						   5 -> Directive[Magenta, Dashed, Thickness[0.002], Opacity[10]]
						 },
						PlotPoints -> PP
				 ];
...
LFVall[
		 ...
		 PP_
				 ...
				 {xfor,xformin,xformax,xforstep},
				 {yfor,yformin,yformax,yforstep}
				 ];
...
Brhtaumu[
			  ...
			  PP_
						...
						FrameLabel ->
						 {
						   Style[xlabel,Larger,Bold],
						   Style[ylabel,Larger,Bold]
						   (*,Style["Subscript[\[Delta]a, \[Mu]]",Larger,Bold]*)
						  },
						PlotLegends -> 
						  {
						  	"h\[Rule]\[Tau]\[Mu]"
						...
						BoundaryStyle -> 
						  {
							1 -> Directive[Blue, Dashed, Thickness[0.002]]
						  },
						PlotPoints->PP
						];
...
HTauMu[
		    ...
		    PP_
		   			...
		   			Brhtaumu[ghtaumu,x,xmin,xmax,y,ymin,ymax,xlabel,ylabel,PP],
					{xfor,xformin,xformax,xforstep},
					{yfor,yformin,yformax,yforstep}
					];
...
Amu[
	   ...
	   PP_
			   ...
			   AxesLabel -> 
		 	   ...
		 	   BoundaryStyle -> 
		 		{
		 		 1 -> Directive[Purple, Dashed, Thickness[0.002]]
		 		},
		 	   PlotPoints -> PP
		       ];
...
Brtauto3muons[
					  ...
					  PP_
					  			...
					  			BoundaryStyle -> 
					  			 {
					  			   1 -> Directive[Orange, Dashed, Thickness[0.002]]
					  			 },
					  			PlotPoints -> PP
					  		    ];
						 ...
						 BoundaryStyle -> 
						  {
  							...
  							2 -> Directive[Green, Dashed, Thickness[0.004], Opacity[10]], 
  							3 -> Directive[Red, Dashed, Thickness[0.002], Opacity[10]],
  							4 -> Directive[Yellow, Dashed, Thickness[0.002],Opacity[10]],
  							5 -> Directive[Magenta, Dashed, Thickness[0.002], Opacity[10]]
  						  },
  						 PlotPoints -> PP
  						 ];
