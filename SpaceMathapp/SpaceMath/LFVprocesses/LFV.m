...
CLTwoLOOPS[
				   ...
				   ghtaumu_,
				   mh_
				   ] := CLTwoLpsA[gAtt,gAtaumu,mA] + CLTwoLpsH[gHtt,gHtaumu,mH] + CLTwoLpsh[ghtt,ghtaumu,mh];
...
CL[
	...
	gAtautau_,
	gHtautau_
	] := CLOneLOOP[ghtaumu,ghtautau,gAtaumu,gAtautau,gHtaumu,gHtautau,mh,mH,mA]+
...
BRtauto3muons[
					  ...
					  mH_,
					  mA_
					  ] := (Ttau*mtau^5)/(256Pi^3) (Sh[ghmumu,ghtaumu]^2/mh^4+SH[gHmumu,gHtaumu]^2/mH^4+
					         SA[gAmumu,gAtaumu]^2/mA^4 (Sh[ghmumu,ghtaumu]*SH[gHmumu,gHtaumu])/((mh^2)( mH^2))+
					         2 SA[gAmumu,gAtaumu]/(3mA^2) (Sh[ghmumu,ghtaumu]/mh^2*SH[gHmumu,gHtaumu]/mH^2));
(************************************************************************************************************************************************************************************************************************************************************************************************************************)
...
BRmuto3electrons[
						 ...
						 mH_,
						 mA_
						 ] := (Tmuon*mmu^5)/(256Pi^3) (Sh1[ghee,ghmue]^2/mh^4+SH1[gHee,gHmue]^2/mH^4+
						        SA1[gAee,gAmue]^2/mA^4 (Sh1[ghee,ghmue]*SH1[gHee,gHmue])/((mh^2)( mH^2))+
						        2 SA1[gAee,gAmue]/(3mA^2) (Sh1[ghee,ghmue]/mh^2*SH1[gHee,gHmue]/mH^2));
(************************************************************************************************************************************************************************************************************************************************************************************************************************)
